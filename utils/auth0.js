...
export default initAuth0({
  ...
  redirectUri: process.env.NEXT_PUBLIC_VERCEL_URL ? `https://ftset3.vercel.app/api/callback` : "http://localhost:3000/api/callback",
  postLogoutRedirectUri: process.env.NEXT_PUBLIC_VERCEL_URL ? 'https://ftset3.vercel.app/' : "http://localhost:3000/",
